		...
		MouseArea {
			...
			Loader {
				...
				source: {
					...
					case 0:
						return "qrc:/pageqml/FileModule.qml"
					case 1:
						return "qrc:/pageqml/BedLevelModule.qml"
					case 2:
						return "qrc:/pageqml/LEDModule.qml"
					default:
						return ""
					}
				}
			...
			Component {
				...
				Rectangle {
					...
					Rectangle {
						...
						//							anchors.fill: parent
						//							onClicked: {
						//								console.log("onClicked: " + input_id)
						//								sender(input_id)
						//							}
						//						}
					}
