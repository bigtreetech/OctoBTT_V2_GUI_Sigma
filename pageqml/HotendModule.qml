...
Item {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Label {
                    ...
                    text: root.currentInfo.current.state.flags.operational
                          === true ? qsTr("Actual") + " : "
                                     + root.currentInfo.current.temps[0].tool0.actual + "℃" : qsTr(
                                         "Actual")
            ...
            Rectangle {
                ...
                Label {
                    ...
                    text: root.currentInfo.current.state.flags.operational
                          === true ? qsTr("Target") + " : "
                                     + root.currentInfo.current.temps[0].tool0.target + "℃" : qsTr(
                                         "Target")
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignHCenter
                    font.pointSize: height * 0.5
        ...
        Rectangle {
            //配置区
            id: hotendSetting_area
            height: parent.height / 2
            anchors.top: hotendPreview_area.bottom
            anchors.horizontalCenter: parent.horizontalCenter
            width: parent.width
            color: "transparent"
            Rectangle {
        ...
        Rectangle {
            ...
            id: hotendBtn_area
            height: parent.height / 4
            anchors.top: hotendSetting_area.bottom
            anchors.horizontalCenter: parent.horizontalCenter
            width: parent.width
            color: "transparent"
            AllBtnStyle {
                ...
                onKeySignal: {
                    numEdit.value = 0
                    functionModule.sentGcodeCommand("M104 S" + numEdit.value)
                }
            }
            AllBtnStyle {
